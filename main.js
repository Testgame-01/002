                  ...
                  var person = prompt("Please enter your name", "");
                    if (person != null) {
                      ...
                      alert(person + ", you have submit " + bestScore + " score");
                        db.collection("games").add({ name: person, score: bestScore }).then(function (docRef) {
                            if (localStorage.getItem("free") == null) {
                                var copyText = document.getElementById("show");
                                copyText.value = "" + docRef.id;
                                document.getElementById("show").innerHTML = copyText.value;
                                var num = localStorage.setItem("free", docRef.id);
                                if (confirm(docRef.id) == true) {
                                    copyText.value = "" + docRef.id;
                                    copyText.select();
                                ...
                                alert("你的序號: " + localStorage.getItem("free"));
                            }
                        })
                      }
